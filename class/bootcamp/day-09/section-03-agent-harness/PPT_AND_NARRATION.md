...
**口播**
> 同学们好，我是你们的老师404。快答开场——Harness 四要素是什么？模型、工具表、记忆、循环。想三秒，心里默念一遍。惊喜来了：这四样你们全摸过。第五天调了模型、做了上下文装配；第七天写的 Skill 就是工具表上的一件工具；你们验收不过改说明书重跑，就是人工版循环。有同学可能会说：404老师，那我们今天学啥？学名字，学结构，学你这两天到底在给谁打工。听见了吗？你们已经在徒手拼 Harness 了，只是还没掀引擎盖。来，看屏幕这张解剖图，咱们逐件认——认完你就知道 Skill 该挂哪，对吧。
