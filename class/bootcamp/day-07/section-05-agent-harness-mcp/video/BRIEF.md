...
flow: automation
storyboard: no
message: "Agent 决策，Harness 骨架，Tool 手，MCP 插座，Workflow 写死，副驾模式 副驾——六词一次讲清。"
...
| slide-06-copilot | 副驾模式 vs 智能体：副驾模式 是你开车它… | photo-panel + duo 副驾/司机 + mile-rail 信任级别 |
...
- 每 slide ≥1 结构化块 + ≥1 具体名词（TRAE / GPT-4 / MCP / function calling 等）
