...
| **训练营** | `bootcamp/` | 十天实战主线（V0.1 → V2.0） | 每天 100–140′，实战为主，三道闸验收 |
...
- 结构蓝本：[`docs/spec/0.4/curriculum-v0.7.md`](../docs/spec/0.4/curriculum-v0.7.md)（Day 1–5）+ [`curriculum-v0.6.md`](../docs/spec/0.4/curriculum-v0.6.md)（Day 6–10）；合约由 [`scripts/build_v07_week1_contracts.py`](../scripts/build_v07_week1_contracts.py) 生成。
